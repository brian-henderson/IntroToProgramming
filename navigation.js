...
var locations = [
	...
	new GameLocation ("You Win!", "Congratulations! You have come back to the statue and with the items you have, you have the keys to gain access to the secret underground temple revealing the REAL King Abbubaker! Thanks for playing!", 0, "abbubakerPowers.jpg")
];
...
function move(dir) {
    ...
    if (nextLocation != null) {
        ...
        showInfoMessage("You cannot go " + dirToStr(dir));
    }
}
